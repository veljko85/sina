      ...
      return this.each(function () {
        ...
        priceBut.onclick = () => {
          if (cartPricesLoaded[0]) {
            ...
            let sina180180LarcheCart = 0;
            let sina90180LarcheCart = 0;
            let sinaKosaLarcheCart = 0;
            let sina18090LarcheCart = 0;
            let sina180180GrauCart = 0;
            let sina90180GrauCart = 0;
            let sinaKosaGrauCart = 0;
            let sina18090GrauCart = 0;
            for (let i = 0; i < allFences.length; i++) {
              ...
              if (fencesArr[i].color == "grau") {
                if (allFences[i][0].isVisible) sina180180GrauCart += 1;
                if (allFences[i][1].isVisible) sina90180GrauCart += 1;
                if (allFences[i][2].isVisible) sina18090GrauCart += 1;
                if (allFences[i][3].isVisible) sinaKosaGrauCart += 1;
                if (allFences[i][4].isVisible) sinaKosaGrauCart += 1;
              }
            }
